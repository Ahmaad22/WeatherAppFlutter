...
class WeatherModel{
   ...
   WeatherModel({required this.date,required this.avgTemp,required this.minTemp,required this.maxTemp,required this.weatherStateName});
factory WeatherModel.fromJson(dynamic data){
  var jsondata = data['forecast']['forecastday'][0]['day'];
 return WeatherModel(avgTemp:jsondata['avgtemp_c'] ,date:data['location']['localtime'] ,maxTemp:jsondata['maxtemp_c'] ,minTemp:jsondata['mintemp_c'] ,weatherStateName:jsondata['condition']['text'] );
